...
function App() {
  ...
  useEffect(() => {
    async function load() {
      try {
        setLoading(true)
        const res = await fetch('/Nirma University - Ahmedabad, India [07 Oct].csv', { cache: 'no-store' })
              ...
              <div className="space-y-6">
                ...
                <div className="group rounded-2xl border border-green-300 bg-gradient-to-br from-green-50 to-emerald-50 p-6 shadow-lg transition-transform hover:-translate-y-1 hover:shadow-xl">
                  <div className="text-center">
                    ...
                    <div className="mt-2 text-xl font-semibold text-amber-600">7th Oct 2025</div>
                  </div>
                </div>
